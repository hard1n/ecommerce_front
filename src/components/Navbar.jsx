    ...
    <>
      <nav className="flex h-full items-center">
        ...
        <div
          ...
          } md:hidden fixed top-0 inset-0 bg-black/50 z-[60]`}
        ></div>
        <div
          className={`${
            activeNav ? "left-0" : "-left-2/3"
          } md:hidden fixed w-2/3 inset-y-0  transition-all flex flex-col xsm:w-1/2 sm:w-1/3 bg-main-bg shadow-2xl z-[70]`}
        >
